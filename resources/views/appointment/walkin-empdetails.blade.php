...
@section('body')    
    ...
    <div class="content pb-0">
        ...
        <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 pb-3 mb-3 border-1 border-bottom">
            <div>
                <h4 class="fw-bold mb-0 d-flex align-items-center"> <a href="{{ route('appointment.walkin.empdetails') }}" class="text-dark"> <i class="ti ti-chevron-left me-1"></i>Walk-In Consultation</a></h4>
            </div>
