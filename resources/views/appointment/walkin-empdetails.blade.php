                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="consultID" class="form-control rounded bg-light" value="EMP-CWI-{{ \Carbon\Carbon::now()->format('Ymd') }}-{{ substr(str_shuffle('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'), 0, 10) }}" readonly>
                                    </div>
                                </div>
                            </div> <!-- end col-->
