<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#medserviceslistab').DataTable({
            "ajax": {
                "url": "{{ route('medservices.show') }}",
                "type": "GET",
            },
            // "bFilter": true,
			// "sDom": 'fBtlpi',  
        ...
        $(document).on('medserverenderAdded', function() {
