    ...
    <div class="row ">
        <div class="col-12">
            <div class="mb-6">
                <div class="row">
                    <div class="col-md-10">
                        <h1 class="fs-3"><i class="ti ti-chevron-left me-1"></i> Walkin Employee Consultations</h1>
                    </div>
                                ...
                                <div class="tab-content mt-1" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-one" role="tabpanel" aria-labelledby="pills-one-tab" tabindex="0">
                                        ...
                                        <div class="table-responsive mt-2 p-3">
                                            <table id="consultationEmpTable" class="table table-hover" style="width: 100%">
                                                <thead class="">
                                                    <tr>
                                                        <th>Patient</th>
                                                        <th>Date</th>
                                    ...
                                    <div class="tab-pane fade" id="pills-two" role="tabpanel" aria-labelledby="pills-two-tab" tabindex="0">
                                        ...
                                        <div class="table-responsive mt-2 p-3">
                                            <table id="referlistEmptab" class="table table-hover" style="width: 100%">
                                                <thead class="">
                                                    <tr>
                                                        <th>Patient</th>
                                                        <th>Date</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="adPVisit" method="POST">
                        ...
                        <input type="hidden" name="stdntID" class="form-control rounded bg-light" value="{{ $patients->emp_ID }}" readonly>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-12">
                                ...
                                <div class="input-group">
                                    <input type="text" name="consultID" class="form-control form-control-sm" value="EMP-CWI-{{ \Carbon\Carbon::now()->format('Ymd') }}-{{ substr(str_shuffle('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'), 0, 10) }}" readonly>
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Type<span class="text-danger">*</span></label>
                                <select class="form-control form-control-sm select2" id="choices-multiple-remove-button" name="pcat">
                                    <option> --Select-- </option>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="bp" placeholder="e.g. 120/80 mmHg">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="pr" placeholder="e.g. 72 bpm">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="rr" placeholder="e.g. 16 bpm">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="spo" placeholder="e.g. 98%">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="btemp" placeholder="e.g. 37°C">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="lmp" placeholder="e.g. 120/80 mmHg">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="pheight" placeholder="e.g. 170 cm">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="pweight" placeholder="e.g. 70 kg">
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <textarea rows="4" name="treatment" class="form-control form-control-sm"> </textarea>
                                </div>
                            </div> <!-- end col-->
