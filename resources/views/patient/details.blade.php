                        ...
                        <ul class="nav nav-pills bg-light p-2 rounded-2" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-two-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-two" aria-selected="false" tabindex="-1"> <i class="ti ti-file-text"></i>
                                    Medical History
                                </button>
                            </li>
                            &nbsp;
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-three-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-three" aria-selected="false" tabindex="-1"> <i class="ti ti-file-time"></i>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-four-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-four" aria-selected="false" tabindex="-1"> <i class="ti ti-file-info"></i>
                    ...
                    <div class="col-md-12">
                        <div class="tab-content mt-1" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-one" role="tabpanel" aria-labelledby="pills-one-tab" tabindex="0">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="d-flex align-items-sm-center justify-content-between flex-wrap pb-3 mb-3 border-1 border-bottom mt-4">
                                                <div>
                            ...
                            <div class="tab-pane fade" id="pills-two" role="tabpanel" aria-labelledby="pills-two-tab" tabindex="0">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="fw-bold mb-0 d-flex align-items-center" style="color: teal"><i class="ti ti-prescription me-1"></i>Medical History</h6>
                                    </div>
                                    <div class="card-body pb-0">
                                        <div class="row g-2">
                                            <div class="col-md-3 text-center bg-light text-dark">
                                                <strong>Disease</strong>
                                            </div>
                                            <div class="col-md-3 text-center bg-light text-dark">
                                                <strong>Specific Disease Remarks</strong>
                                            </div>
                                            <div class="col-md-2 text-center bg-light text-dark">
                                                <strong>Hospital Confinement</strong>
                                            </div>
                                            <div class="col-md-4 text-center bg-light text-dark">
                            ...
                            <div class="tab-pane fade" id="pills-three" role="tabpanel" aria-labelledby="pills-three-tab" tabindex="0">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="fw-bold mb-0 d-flex align-items-center" style="color: teal"><i class="ti ti-heart me-1"></i>Physical Examination</h6>
                                    </div>
                                    <div class="card-body pb-0">
                                        <div class="row g-2">
                                            <div class="col-md-2 text-center bg-light text-dark">
                                            ...
                                            <div class="col-md-6 text-center bg-light text-dark">
                            ...
                            <div class="tab-pane fade" id="pills-four" role="tabpanel" aria-labelledby="pills-four-tab" tabindex="0">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="fw-bold mb-0 d-flex align-items-center" style="color: teal"><i class="ti ti-file me-1"></i>Patient Data Records</h6>
                                    </div>
                                    <div class="card-body pb-0">
                                        <div class="row g-3">
                                            <style>
