    ...
    */
    ...
    'connections' => [
        ...
        'admission' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('ADMSSION_DB_HOST', '127.0.0.1'),
            'port' => env('ADMSSION_DB_PORT', '3306'),
            'database' => env('ADMSSION_DB_DATABASE', 'forge'),
            'username' => env('ADMSSION_DB_USERNAME', 'forge'),
            'password' => env('ADMSSION_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'hremp' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('EMP_DB_HOST', '127.0.0.1'),
            'port' => env('EMP_DB_PORT', '3306'),
            'database' => env('EMP_DB_DATABASE', 'forge'),
            'username' => env('EMP_DB_USERNAME', 'forge'),
            'password' => env('EMP_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
